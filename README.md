...
```
cd existing_repo
git remote add origin https://gitlab.com/Yuvraj26/real-time-stock-market-data-processing-engine-using-kafka-data-engineering-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Yuvraj26/real-time-stock-market-data-processing-engine-using-kafka-data-engineering-project/-/settings/integrations)
